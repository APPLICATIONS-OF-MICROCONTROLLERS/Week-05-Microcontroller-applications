...
-กล่องเก็บของที่เปลี่ยนได้ เร็ว แต่เล็ก
2. **Address Ranges**: ตัวแปรแต่ละประเภทอยู่ใน address range ไหน?
-กล่องเก็บของที่ไม่เปลี่ยน ช้า แต่ใหญ่
3. **Memory Usage**: ESP32 มี memory ทั้งหมดเท่าไร และใช้ไปเท่าไร?
-กล่องใหญ่ 508 KB ใช้ไป 137 KB เหลือ 371 KB
...
-ข้อมูลที่อยู่ติดกันถูกโหลดเข้ามาพร้อมกันใน cache ทำให้ไม่ต้องอ่านจากหน่วยความจำ
2. **Memory Hierarchy**: ความแตกต่างระหว่าง internal SRAM และ external memory คืออะไร?
•	Internal SRAM: อยู่ในชิป, เร็ว, เหมาะกับข้อมูลสำคัญ
	•	External Memory: อยู่นอกชิป, ช้า, ใช้เก็บข้อมูลเยอะ ๆ
3. **Stride Patterns**: stride size ส่งผลต่อ performance อย่างไร?
stride เล็กก็จะยิ่งเร็ว
---
...
| Average Time per Iteration (μs) | 66 | 11376 |
