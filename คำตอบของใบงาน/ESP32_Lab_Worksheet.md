...
### ตอบ SRAM: ใช้เก็บข้อมูลที่เปลี่ยนแปลงได้ระหว่างโปรแกรมทำงาน เช่น ตัวแปรใน stack, heap, global

### Flash Memory: ใช้เก็บข้อมูลถาวร เช่น โค้ดโปรแกรม และค่าคงที่ (const, string literal)
---
...
### ตอบ Sequential access เร็วกว่าเพราะข้อมูลอยู่ติดกัน → cache โหลดล่วงหน้าได้
### Random access ทำให้ cache miss บ่อย → ช้ากว่า
---
2. **Memory Hierarchy**: ความแตกต่างระหว่าง internal SRAM และ external memory คืออะไร?
### ตอบ Internal SRAM อยู่ในชิป เร็วกว่า
### External memory อยู่ภายนอก ช้ากว่า ~5 เท่า เหมาะกับข้อมูลใหญ่

---
3. **Stride Patterns**: stride size ส่งผลต่อ performance อย่างไร?
### ตอบ Stride ใหญ่ขึ้น → เวลา access ลดลง เพราะข้ามข้อมูล
### แต่เข้าถึงข้อมูลน้อยลง → ต้องใช้ให้เหมาะกับงาน
...
### ตอบ Core 0 (PRO_CPU): เหมาะกับงานที่ต้องการประมวลผลเร็ว
### Core 1 (APP_CPU): เหมาะกับงานที่ต้องการการประมวลผลช้าแต่รองรับการทำงานหลายๆ อย่างพร้อมกัน
2. **Communication Overhead**: inter-core communication มี overhead เท่าไร?
### ตอบ ค่า Latency ที่สูงระหว่างการส่งข้อความจาก Core 0 ไป Core 1 โดยมีค่าเฉลี่ยที่ ประมาณ 16,000 μs บ่งบอกถึง overhead ที่สูงในการสื่อสารระหว่าง cores

3. **Load Balancing**: การกระจายงานระหว่าง cores มีประสิทธิภาพหรือไม่?
### ตอบ การกระจายงานไม่สมดุล เนื่องจาก Core 0 ทำงานได้เร็ว (100 iterations ใน 4996 ms) แต่ Core 1 ใช้เวลาในการประมวลผลมากกว่า (150 iterations ใน 5946 ms)
...
**ข้อมูลนักศึกษา:**
- ชื่อ: นาย ภวินท์ ศรีศิริวัฒน์
- รหัสนักศึกษา: 67030166
- วันที่ทำการทดลอง: 30/07/2025
